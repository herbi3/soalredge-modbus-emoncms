...
class Inverter(SolarEdge):
	...
	def __init__(self, *args, **kwargs):
		...
		self.registers = {
			...
			"op-mode":(0x9c43, 1, registerType.HOLDING, registerDataType.UINT16, int, "Operation Mode", "16Bit Words", 1),
			...
			"c_sunspec_did": (0x9c85, 1, registerType.HOLDING, registerDataType.UINT16, int, "SunSpec DID", "", 2),
